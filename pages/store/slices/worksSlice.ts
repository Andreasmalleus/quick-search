...
const initialState = { works : [], isLoading : false, hasErrors : false, hasMore : false} as WorksState
...
export const {setLoading, setWorks, setError, clearWorks, appendToWorks} = worksSlice.actions
